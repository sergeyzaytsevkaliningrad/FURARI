...
final class IsbnScannerViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    private let scannerDelegate: ISBNScannerDelegate
    
    init(scannerDelegate: ISBNScannerDelegate) {
    ...
    override func viewDidLoad() {
        ...
        let scanRect = CGRect(x: 0, y: view.center.y - (view.layer.bounds.height * 0.4 / 2), width: view.layer.bounds.width, height: view.layer.bounds.height * 0.4)
    ...
    func found(code: String) {
        scannerDelegate.ISBNCodeHandler(code: code)
    }
